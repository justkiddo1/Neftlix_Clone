    ...
    return (
        <div className="loginContainer min-h-screen bg-black relative flex items-center justify-center overflow-hidden">
            ...
            <div className="max-w-[480px] w-full bg-[#000000b3] backdrop-blur-sm rounded-sm py-12 px-16 
                ...
                <Input type="text" placeholder="Username" className="py-6 px-4" name={name} onChange={(e) => setName(e.target.value)} />
                ...
                <button className="cursor-pointer w-full bg-[#e50914] hover:bg-[#f40612] 
                         text-base font-medium rounded-lg py-3.5 transition" onClick={handleSignUp}>
                    Sign Up
                </button>
                ...
                <div className="text-center">
                    ...
                    <Link href="/login" className="font-medium text-base hover:underline">
                        Login
                    </Link>
                </div>
            </div>
